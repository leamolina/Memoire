...
feature_importance_df.to_csv('results_catch22/Interface/feature_importance.csv', index=False)
...
plt.tight_layout()
plt.savefig('results_catch22/Interface/feature_importance_rf.png', dpi=300)
plt.close()
...
for group_name, features in feature_groups.items():
    ...
    try:
        ...
        plt.savefig(f'results_catch22/Interface/subspace_clustering_{group_name}.png', dpi=300)
        plt.close()
    except Exception as e:
...
for name, embedding in embeddings.items():
    ...
    try:
        ...
        plt.savefig(f'results_catch22/Interface/dimensionality_reduction/clustering_{name}.png', dpi=300)
        plt.close()
    except Exception as e:
        print(f"  Erreur lors de l'évaluation: {e}")
...
if len(partitions) >= 5:
    ...
    try:
        ...
        plt.savefig('results_catch22/Interface/consensus_co_association.png', dpi=300)
        plt.close()
        ...
        plt.savefig('results_catch22/Interface/consensus_kmeans_clusters.png', dpi=300)
        plt.close()
        ...
        plt.savefig('results_catch22/Interface/consensus_hclust_clusters.png', dpi=300)
        plt.close()
    except Exception as e:
